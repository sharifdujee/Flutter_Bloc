...
import 'package:flutter_roadmap/coivd_tracker_apps/country_wise_list.dart';
...
class _WorldStatesState extends State<WorldStates> with TickerProviderStateMixin {
  ...
  WorldStateModel newsListViewModel = WorldStateModel();
                      ...
                      if(!snapshot.hasData){
                        ...
                        return Column(
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const CountryWiseList()));
                              },
                              child: Container(
                                height: 50,
